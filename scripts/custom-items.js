const customItemDb = {
    ...
    books: ['books'] // Usamos el ID estándar del libro
};
...
const enchantFilters = {
    ...
    armor: ["protection", "fireprotection", "featherfalling", "blastprotection", "projectileprotection", "respiration", "aquaaffinity", "thorns", "unbreaking", "mending"]
};
...
function selectCustomItem(itemID, category) {
    ...
    if (category === 'books') {
        ...
        validEnchants = getFilteredEnchants(enchantFilters.armor);
    } else if (itemID === 'bow') {
